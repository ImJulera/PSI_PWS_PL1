                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h1 class="card-title m-0">Editar <?= $user->role ?></h1>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="./?c=user&a=update&id=<?=$user->id?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="password" name="password"><?php if(isset($user->errors)){ echo $user->errors->on('password');} ?>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">Editar</button> <a href="./?c=user&a=index&tipo=<?=$user->role?>" class="btn btn-primary float-right">Voltar</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
